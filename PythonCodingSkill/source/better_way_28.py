...
print('Index 2 = ', tree[2])
print('Index 3 = ', tree[3])
print('Index 4 = ', tree[4])
print('Index 5 = ', tree[5])
...
foo = BetterNode(10,
                 left=BetterNode(5,
                                 left=BetterNode(2),
                                 right=BetterNode(6, right=BetterNode(5))),
                 right=BetterNode(15, left=BetterNode(11)))

print('Index of 7 is', foo.index(5))
print('Count of 10 is', foo.count(5))
print('Size is ', len(foo))
